...
async function debug() {
    ...
    if (data.length > 0) {
        ...
        console.log("hasContentColumns:", hasColumn('permalink') || hasColumn('link permanente') || hasColumn('tipo de conte') || hasColumn('tipo de post'));
        console.log("data[0]['Alcance'] !== undefined:", typeof data[0]['Alcance'] !== 'undefined');
        console.log("hasColumn('curtidas'):", hasColumn('curtidas'));
        console.log("hasColumn('respostas'):", hasColumn('respostas'));
